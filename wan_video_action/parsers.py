...
def add_dataset_base_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--dataset_metadata_path", "--train_dataset_metadata_path", dest="dataset_metadata_path", type=str, default=None, help="[REQUIRED] Path to the training metadata file.")
    group.add_argument("--val_dataset_metadata_path", type=str, default=None, help="[OPTIONAL] Path to the validation metadata file.")
